...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("HomeWork/4HomeWork/2Task/file1.txt", create_str(koef1))
write_file("HomeWork/4HomeWork/2Task/file2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('HomeWork/4HomeWork/2Task/file1.txt', 'r') as data:
    st1 = data.readlines()
with open('HomeWork/4HomeWork/2Task/file2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("HomeWork/4HomeWork/2Task/file3.txt", create_str(lst_new))
with open('HomeWork/4HomeWork/2Task/file3.txt', 'r') as data:
    st3 = data.readlines()
